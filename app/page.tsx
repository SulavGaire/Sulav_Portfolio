    ...
    <div className="mb-8">
      ...
      <h1 className="flex flex-row font-outfit font-bold text-2xl text-heading leading-[43.2px] tracking-[-1.5px] my-8">
        ...
        <Typewriter
          words={[
            " Sulav Gaire",
            "an Electronics & Information Engineer",
            "a software developer",
            "an artist",
          ]}
        />
      </h1>
      <p className="transition ease-in-out delay-150 font-mono font-medium text-base text-paragraph leading-7 mb-8">
      ...
      <p className="font-mono font-medium text-base text-paragraph leading-7 mb-8 transition">
        <Link
          href="Sulav_CV.pdf"
          className="border-[1px] border-paragraph p-2 rounded-full hover:bg-violet-200 active:bg-violet-300"
        >
          Resume
        </Link>
      </p>
      <Link href="https://orion-space-site.vercel.app/" target="_blank" rel="noopener noreferrer">
        <p className="flex flex-row font-outfit font-bold text-base text-paragraph leading-7 mb-8 hover:underline">
          Currently working on
          <CodeIcon
            size={30}
            className="mx-4 animate-bounce hover:animate-spin"
          />
        </p>
      </Link>
    </div>
